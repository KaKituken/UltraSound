	soc_system u0 (
		...
		.fifo_delay_pipe_out_waitrequest       (<connected-to-fifo_delay_pipe_out_waitrequest>),       //                             .waitrequest
		.fifo_delay_pipe_out_csr_address       (<connected-to-fifo_delay_pipe_out_csr_address>),       //      fifo_delay_pipe_out_csr.address
		.fifo_delay_pipe_out_csr_read          (<connected-to-fifo_delay_pipe_out_csr_read>),          //                             .read
		.fifo_delay_pipe_out_csr_writedata     (<connected-to-fifo_delay_pipe_out_csr_writedata>),     //                             .writedata
		.fifo_delay_pipe_out_csr_write         (<connected-to-fifo_delay_pipe_out_csr_write>),         //                             .write
		...
		.pwm_adc_clk_out_clk_clk               (<connected-to-pwm_adc_clk_out_clk_clk>),               //          pwm_adc_clk_out_clk.clk
