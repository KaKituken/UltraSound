...
#define FIFO_REG_BASE 0x0100
#define WAIT {}

#define FIFO_WRITE		     (*(h2p_FIFO_addr))
...
//-----------------------------------------------
	...
	volatile unsigned int *h2p_FIFO_addr; //FIFO via AXI master
	volatile unsigned int *h2p_lw_FIFO_reg_addr; // FIFO register via 
