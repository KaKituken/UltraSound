 ...
 * file '/cygdrive/d/Ultrasound/Code/alteas/Access_FIFO_Dev/QuartusCode/soc_system_160807_restored/soc_system.sopcinfo'.
 */
...
#define PIO_REG1_SPAN 32
#define PIO_REG1_END 0x2f
...
#define PIO_REG2_SPAN 32
#define PIO_REG2_END 0x3f
...
#define PIO_REG3_SPAN 32
#define PIO_REG3_END 0x4f
...
#define FIFO_0_IN_CSR_BASE 0x100
#define FIFO_0_IN_CSR_SPAN 32
#define FIFO_0_IN_CSR_END 0x11f
...
#define SYSID_QSYS_TIMESTAMP 1640332522
...
#define FIFO_0_IN_BASE 0x30000
#define FIFO_0_IN_SPAN 4
#define FIFO_0_IN_END 0x30003
...
#define FIFO_0_IN_FIFO_DEPTH 4096
...
/*
 * Macros for device 'fifo_delay_pipe_in', class 'altera_avalon_fifo'
 * The macros are prefixed with 'FIFO_DELAY_PIPE_IN_'.
 * The prefix is the slave descriptor.
 */
#define FIFO_DELAY_PIPE_IN_COMPONENT_TYPE altera_avalon_fifo
#define FIFO_DELAY_PIPE_IN_COMPONENT_NAME fifo_delay_pipe
#define FIFO_DELAY_PIPE_IN_BASE 0x40000
#define FIFO_DELAY_PIPE_IN_SPAN 4
#define FIFO_DELAY_PIPE_IN_END 0x40003
#define FIFO_DELAY_PIPE_IN_AVALONMM_AVALONMM_DATA_WIDTH 32
#define FIFO_DELAY_PIPE_IN_AVALONMM_AVALONST_DATA_WIDTH 32
#define FIFO_DELAY_PIPE_IN_BITS_PER_SYMBOL 16
#define FIFO_DELAY_PIPE_IN_CHANNEL_WIDTH 8
#define FIFO_DELAY_PIPE_IN_ERROR_WIDTH 8
#define FIFO_DELAY_PIPE_IN_FIFO_DEPTH 256
#define FIFO_DELAY_PIPE_IN_SINGLE_CLOCK_MODE 0
#define FIFO_DELAY_PIPE_IN_SYMBOLS_PER_BEAT 2
#define FIFO_DELAY_PIPE_IN_USE_AVALONMM_READ_SLAVE 1
#define FIFO_DELAY_PIPE_IN_USE_AVALONMM_WRITE_SLAVE 1
#define FIFO_DELAY_PIPE_IN_USE_AVALONST_SINK 0
#define FIFO_DELAY_PIPE_IN_USE_AVALONST_SOURCE 0
#define FIFO_DELAY_PIPE_IN_USE_BACKPRESSURE 1
#define FIFO_DELAY_PIPE_IN_USE_IRQ 0
#define FIFO_DELAY_PIPE_IN_USE_PACKET 1
#define FIFO_DELAY_PIPE_IN_USE_READ_CONTROL 1
#define FIFO_DELAY_PIPE_IN_USE_REGISTER 0
#define FIFO_DELAY_PIPE_IN_USE_WRITE_CONTROL 1

/*
 * Macros for device 'fifo_delay_pipe_in_csr', class 'altera_avalon_fifo'
 * The macros are prefixed with 'FIFO_DELAY_PIPE_IN_CSR_'.
 * The prefix is the slave descriptor.
 */
#define FIFO_DELAY_PIPE_IN_CSR_COMPONENT_TYPE altera_avalon_fifo
#define FIFO_DELAY_PIPE_IN_CSR_COMPONENT_NAME fifo_delay_pipe
#define FIFO_DELAY_PIPE_IN_CSR_BASE 0x41000
#define FIFO_DELAY_PIPE_IN_CSR_SPAN 32
#define FIFO_DELAY_PIPE_IN_CSR_END 0x4101f
#define FIFO_DELAY_PIPE_IN_CSR_AVALONMM_AVALONMM_DATA_WIDTH 32
#define FIFO_DELAY_PIPE_IN_CSR_AVALONMM_AVALONST_DATA_WIDTH 32
#define FIFO_DELAY_PIPE_IN_CSR_BITS_PER_SYMBOL 16
#define FIFO_DELAY_PIPE_IN_CSR_CHANNEL_WIDTH 8
#define FIFO_DELAY_PIPE_IN_CSR_ERROR_WIDTH 8
#define FIFO_DELAY_PIPE_IN_CSR_FIFO_DEPTH 256
#define FIFO_DELAY_PIPE_IN_CSR_SINGLE_CLOCK_MODE 0
#define FIFO_DELAY_PIPE_IN_CSR_SYMBOLS_PER_BEAT 2
#define FIFO_DELAY_PIPE_IN_CSR_USE_AVALONMM_READ_SLAVE 1
#define FIFO_DELAY_PIPE_IN_CSR_USE_AVALONMM_WRITE_SLAVE 1
#define FIFO_DELAY_PIPE_IN_CSR_USE_AVALONST_SINK 0
#define FIFO_DELAY_PIPE_IN_CSR_USE_AVALONST_SOURCE 0
#define FIFO_DELAY_PIPE_IN_CSR_USE_BACKPRESSURE 1
#define FIFO_DELAY_PIPE_IN_CSR_USE_IRQ 0
#define FIFO_DELAY_PIPE_IN_CSR_USE_PACKET 1
#define FIFO_DELAY_PIPE_IN_CSR_USE_READ_CONTROL 1
#define FIFO_DELAY_PIPE_IN_CSR_USE_REGISTER 0
#define FIFO_DELAY_PIPE_IN_CSR_USE_WRITE_CONTROL 1
